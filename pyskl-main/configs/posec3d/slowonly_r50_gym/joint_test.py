...
train_pipeline = [
    dict(type='AdaptiveSampleFrames', clip_len=48),
...
val_pipeline = [
    dict(type='AdaptiveSampleFrames', clip_len=48, num_clips=1, test_mode=True),
    dict(type='PoseDecode'),
    dict(type='PoseCompact', hw_ratio=1., allow_imgpad=True),
...
test_pipeline = [
    dict(type='AdaptiveSampleFrames', clip_len=48, num_clips=10, test_mode=True),
    dict(type='PoseDecode'),
    dict(type='PoseCompact', hw_ratio=1., allow_imgpad=True),
    dict(type='Resize', scale=(64, 64), keep_ratio=False),
